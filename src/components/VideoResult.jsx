  ...
  return (
    <div className="w-full lg:h-[210px] md:h-[180px] h-[340px] relative mb-[30px]">
      <div className="w-full h-full flex flex-col md:flex-row">
        <div
          style={{
            backgroundImage: `url(https://i.ytimg.com/vi/Olhqs3CWUAU/maxresdefault.jpg)`,
          }}
          className="h-full 2xl:w-[23%] lg:w-[30%] md:w-[35%] w-full rounded-xl bg-cover relative bg-center">
        ...
        <div className="md:pl-[20px]">
          ...
          <div className="flex items-center">
            <div
              style={{
                backgroundImage: `url(https://yt3.googleusercontent.com/0s4g6_BwK9CyfAy_j6eF204d86TzIAvrLZNmh9BVrYFpXrhDxjKaheX0m8wowJg1h53HR_-8Vw=s900-c-k-c0x00ffffff-no-rj)`,
              }}
              className="h-[25px] w-[25px] rounded-full bg-cover"></div>
