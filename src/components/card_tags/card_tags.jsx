        ...
        <div className='card-container'>
            <div className = 'card'>
                <div className='header'>
                    {"Tags"}
                    <svg id='copyIconTags' className='svgicon' onClick={copyToClipboard} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className='tag-box'>
                    {tags.map((e, index) =>  <div className='messages'><span key={index}>{"#" + e.tag}</span></div>)}
                </div>
            </div>
        </div>
    );
